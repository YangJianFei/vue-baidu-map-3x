 ...
 * Created Date: Tuesday, November 8th 2022, 3:17:19 pm
    ...
    <NavBar v-if="showNavbar" @toggle="toggleSidebar">
      ...
      <template #search>
        <slot name="navbar-search">
          <AlgoliaSearchBox v-if="theme.algolia" :options="theme.algolia" :multilang="isMultiLang" />
        </slot>
      </template>
    </NavBar>
    ...
    <Page v-else>
      ...
      <template #bottom>
        ...
        <slot name="page-bottom-ads">
          <BuySellAds v-if="theme.carbonAds && theme.carbonAds.custom" :key="'custom' + page.relativePath" :code="theme.carbonAds.custom"
