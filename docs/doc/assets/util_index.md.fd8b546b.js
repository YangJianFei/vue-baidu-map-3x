...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
getPointByAddress<span class="token punctuation">(</span>config, <span class="token punctuation">[</span><span class="token string">&#39;\u4F60\u7684ak&#39;</span><span class="token punctuation">]</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers-wrapper"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br></div></div><h2 id="getpointstransfer-\u5750\u6807\u8F6C\u6362" tabindex="-1">getPointsTransfer \u5750\u6807\u8F6C\u6362 <a class="header-anchor" href="#getpointstransfer-\u5750\u6807\u8F6C\u6362" aria-hidden="true">#</a></h2><p>\u793A\u4F8B</p><div class="language-bash line-numbers-mode"><pre><code><span class="token function">import</span> <span class="token punctuation">{</span> getPointsTransfer <span class="token punctuation">}</span> from <span class="token string">&#39;vue-baidu-map-3x&#39;</span><span class="token punctuation">;</span>
...
const config <span class="token operator">=</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">]</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
getPointsTransfer<span class="token punctuation">(</span>config, <span class="token punctuation">[</span><span class="token string">&#39;\u4F60\u7684ak&#39;</span><span class="token punctuation">]</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
